...
function RentalViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; tool: boolean; outlet: boolean } }>(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'tool', 'outlet'],
          id,
        },
        'rental',
      ),
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem
                  label="Rental Date"
                  text={data?.rental_date ? format(data?.rental_date, 'dd-MM-yyyy') : ''}
                />

                <FormListItem
                  label="Return Date"
                  text={data?.return_date ? format(data?.return_date, 'dd-MM-yyyy') : ''}
                />
